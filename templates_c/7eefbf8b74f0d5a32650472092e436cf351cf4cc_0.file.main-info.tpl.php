...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62615fb853d9a7_20520610',
...
function content_62615fb853d9a7_20520610 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="mb-3 d-flex align-items-center">
        ...
        <div class="col-lg-10 pl-3">
            ...
            <div class="d-flex mt-4">
                <div class="col-lg-3">
                    <p>Kód pozvánky: <strong>58UEWXQTPO</strong></p>
                </div>
                <div class="col-lg-3">
                    <p>Tento měsíc utraceno: <strong>24 569,-</strong></p>
                </div>
                <div class="col-lg-3">
                    <p>Počet kontaktů: <strong>245</strong></p>
                </div>
                <div class="col-lg-3">
                    <p>Pozval/a vás: <strong>Matěj Kubeček</strong></p>
                </div>
            </div>
        </div>
    </div>
